  ...
  return (
    ...
    >
      <Col xs={6} md={searchedVideo ? 4 : 6} className="videoHorizontal_left">
        ...
        />
        <span className="videoHorizontal_left_duration">{_duration}</span>
      </Col>
      <Col
        xs={6}
        md={searchedVideo ? 8 : 6}
        className="videoHorizontal_right py-3 d-flex flex-column justify-content-between"
      >
